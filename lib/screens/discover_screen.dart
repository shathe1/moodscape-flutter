...
class _DiscoverScreenState extends State<DiscoverScreen> {
  ...
  final List<_Place> _places = [
    _Place(name: 'Hidden Rooftop Café', emoji: '☕', color: const Color(0xFFD4CCF8), rating: 4.8, distanceKm: 1.2),
    _Place(name: 'Indoor Arcade Night', emoji: '🕹️', color: const Color(0xFFFDE3CB), rating: 4.6, distanceKm: 2.4),
    _Place(name: 'Sunset Hiking Spot', emoji: '🥾', color: const Color(0xFFC5EDD8), rating: 4.9, distanceKm: 5.1),
  ];
          ...
          children: [
            Container(
              ...
              decoration: const BoxDecoration(
                gradient: LinearGradient(colors: [AppColors.secondary, Color(0xFFFFB3CC)]),
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final bool isSaved = _savedIndexes.contains(index);
                  return Container(
                          ...
                          children: [
                            ...
                            Positioned(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  setState(() {
                                    isSaved ? _savedIndexes.remove(index) : _savedIndexes.add(index);
                                  });
                                },
                                child: CircleAvatar(
                                  radius: 14,
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text('${place.rating}', style: const TextStyle(fontSize: 11, color: AppColors.textDark)),
